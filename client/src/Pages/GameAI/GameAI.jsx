    ...
    <div id="BigManCon">
      ...
      
      {
        <div className="turnu">
          ...
          <h1>{winner == 0 ? "Game Playing..." : winner  }</h1>
        </div>
        ...
        <div className="mancalaGrid">
          ...
          {Object.keys(game).map((pit,index) => (
            ...
            (pit === "M2")  ?
              <div className="mancala-store" id={`${pit}`} key={pit} >{pit} : {game[pit]}</div>
            :
              <div className="mancala-pit" id={`pit-${pit}`} key={pit}  >
                {pit} : {game[pit]}
                </div>
        ...
        <div className="lunch" onClick={(e) => computerMove(e)}>
          Launch
        </div>
